                ...
                <Row className="justify-content-center">
                    ...
                    <Card className="d-flex justify-content-center mb-0 p-3">
                        <Card.Body>
                            ...
                            <p className="cnf-mail mb-1">The password has been reset successfully. Please click the button so that you can login with your new password.</p>
                            <div className="d-inline-block w-100">
                                <Link to="/" className="btn btn-primary mt-3">Back to login</Link>
                            </div>
                        </Card.Body>
                    </Card>
                    </Col>
